        ...
        if (dto.getEmployee().getId() == null) {
            ...
            if (del_q_em.size() > 0) {
                for (EmergencyContactDTO del_dd : del_q_em) {
                    if (del_dd.getEmployee().getId().equals(old.getId()))
        ...
        for (int i = 0; i < ids.length; i++) {
            ...
            if (emergencys.size() > 0) {
                for (EmergencyContactDTO em : emergencys) {
                    if (em.getEmployee().getId().equals(ids[i]))
            ...
            if (experiences.size() > 0) {
                for (ExperienceDTO ex : experiences) {
                    if (ex.getEmployee().getId().equals(ids[i]))
            ...
            if (familys.size() > 0) {
                for (FamilyDTO f : familys) {
                    if (f.getEmployee().getId().equals(ids[i]))
            ...
            if (educations.size() > 0) {
                for (EducationDTO e : educations) {
                    if (e.getEmployee().getId().equals(ids[i]))
