...
// 填充整个父窗口
var layer_stretch_width=(function () {return window.innerWidth + "px";})();
var layer_stretch_height=(function () {return window.innerHeight + "px";})();

// 父窗口较大时居中，过小时填满宽或高
var layer_elastic_width=(function () {
    var layerWidth;
    if (window.innerWidth < 500) {
        layerWidth = window.innerWidth + "px";
    } else {
        layerWidth = window.innerWidth - 150 + "px";
    }
    return layerWidth;
})();
var layer_elastic_height = (function () {
    var layerHeight;
    if (window.innerHeight < 350) {
    	layerHeight = window.innerHeight + 'px';
    } else {
    	layerHeight = window.innerHeight - 50 + 'px';
    }
    return layerHeight;
})();
...
function open_tab(url, title) {
	var id = uuid();
	var a = '<a href="' + url + '" class="J_menuItem" id="' + id + '" style="display:none;">' + title + '</a>';
	$('body').append(a);
	$('#' + id).click();
