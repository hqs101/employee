            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                    	<form role="form" class="form-inline" id="query-form" method="post" action="${ctx }/admin/emergencyContact/list" >
                    		<!-- 查询开始 -->
...
<script>
function add() {
    k.layer.add("${ctx}/admin/emergencyContact/detail");
}
...
function edit() {
	...
	k.layer.edit("${ctx}/admin/emergencyContact/detail?id=" + id);
}
var page = "${page.page}";
function reload() {
	page_submit(page);
...
function del() {
	k.layer.del("${ctx}/admin/emergencyContact/delete");	
}
